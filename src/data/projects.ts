...
export const projects: Project[] = [
  ...
  {
    id: "dailyrota",
    title: "Rota · DailyTracker: Personal Life & Finance Operating Hub",
    tagline: "Voice & NLP-Powered Mobile-First Personal Life Hub with Multi-Model AI Fallback & Cloud Secret Vault",
    description:
      "An all-in-one personal operating hub unifying personal finance, tasks, groceries, pantry inventory, habits, and vehicle telemetry—powered by conversational Turkish voice/text commands, transactional action previews, offline rules, and resilient multi-model AI fallback.",
    year: "2026",
    category: "Mobile Web / Personal Life & Finance Hub",
    ...
    caseStudy: {
      overview:
        "A unified personal operating ecosystem replacing fragmented finance, task, grocery, and calendar apps. It converts complex conversational voice and text commands into atomic, pre-validated actions with complete data sovereignty and seamless calendar export.",
      challenge:
        "Eliminating vendor lock-in and network dependencies while parsing complex conversational Turkish queries. Required zero-latency offline rule evaluation alongside a fault-tolerant multi-model fallback chain (Gemini, Groq, DeepSeek, Ollama) and secure API key isolation via Google Cloud Secret Manager.",
      solution:
        "Engineered an offline-first Turkish NLP rule engine complemented by a cloud-secured multi-model fallback gateway using Firebase Secret Manager and Cloud Functions. Implemented transactional action previews with 100-step undo capability and Firebase App Check, fully validated by 114 automated tests.",
      keyFeatures: [
      ...
      metrics: [
        { label: "AI Architecture", value: "Hybrid / 5+ LLMs" },
        { label: "Rollback & Safety", value: "100-Step Undo" },
